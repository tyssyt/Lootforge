...
attribute_alias! {
   #[apply(UnitEnum)] = #[derive(Clone, Copy, PartialEq, Eq, strum::EnumIter, strum::VariantArray, strum::EnumCount, strum::EnumIs, strum::FromRepr, strum::IntoStaticStr, derive_more::Debug, derive_more::Unwrap)];
